...
export const t = {
  en: {
    ...
    odds: {
      ...
      subtitle: 'FIFA World Cup 2026',
      tabBookmakers: 'Bookmakers',
      tabMarket: 'Prediction Market',
      rank: '#',
      team: 'Team',
      ...
      bestOdds: 'Best Odds',
      bookmaker: 'Bookmaker',
      sourceBookmakers: 'Best odds from EU/UK bookmakers via The Odds API · updates every hour',
      sourcePolymarket: 'Powered by Polymarket prediction markets · updates every hour',
    },
    intel: {
      back: '← Explorer',
  ...
  he: {
    ...
    odds: {
      ...
      subtitle: 'גביע העולם פיפ״א 2026',
      tabBookmakers: 'בתי הימורים',
      tabMarket: 'שוק תחזיות',
      rank: '#',
      team: 'נבחרת',
      probability: 'סיכוי לנצח',
      decimal_odds: 'מכפיל',
      bestOdds: 'מכפיל מקסימלי',
      bookmaker: 'בית הימורים',
      sourceBookmakers: 'מיטב המכפילים מבתי הימורים · מתעדכן כל שעה',
      sourcePolymarket: 'מופעל על ידי Polymarket · מתעדכן כל שעה',
    },
    intel: {
      back: '← חזרה',
